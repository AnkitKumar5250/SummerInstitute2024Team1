...
public class PositioningConstants {
    ...
    // Positions on the left and right of the human player zone where the robot will
    // osolate between while picking up balls
    ...
    // 3D coordinate that marks the exact position in which the ball has to make
    // contact with the cell bank
